import { d as commonjsGlobal, e as getDefaultExportFromCjs, r as reactExports, h as clsx, R as React, i as invariant, j as jsxRuntimeExports, k as LoadingPage, a as formatScore, f as formatDate } from "./index-CQoy5yrU.js";
import { P as ProtectedLayout, C as ChartColumn, b as ShoppingBag, S as Shield, a as Search } from "./Layout-C9fB1GFD.js";
...
import { g as getDashboardStats } from "./api-DPQZoKDZ.js";
...
function Dashboard() {
  ...
  if (loading)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingPage, {}) });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-10 max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-3xl text-foreground mb-1", children: "Dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body", children: "Your review analysis activity and insights." })
    ] }),
        ...
        children: [
          {
            ...
            value: (stats == null ? void 0 : stats.totalAnalyzed) ?? 0,
            icon: ChartColumn,
            color: "text-primary"
          },
          {
            label: "Fake Detected",
            value: (stats == null ? void 0 : stats.fakeDetected) ?? 0,
            icon: TrendingDown,
            color: "text-red-500"
          },
          {
            label: "Real Verified",
            value: (stats == null ? void 0 : stats.realVerified) ?? 0,
            icon: TrendingUp,
            color: "text-emerald-500"
          },
          {
            label: "Products Checked",
            value: (stats == null ? void 0 : stats.productsChecked) ?? 0,
            icon: ShoppingBag,
            color: "text-accent"
          }
        ].map(({ label, value, icon: Icon, color: color2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5 pb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-body", children: label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `w-4 h-4 ${color2}` })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-display font-bold text-foreground", children: value.toLocaleString() })
        ] }) }, label))
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "mb-8 bg-gradient-to-r from-primary/5 to-accent/5 border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-full bg-accent/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-6 h-6 text-accent" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-body mb-0.5", children: "Overall Trust Score" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-display font-bold text-foreground", children: formatScore((stats == null ? void 0 : stats.trustScore) ?? 0) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Badge,
        {
          variant: stats && stats.trustScore >= 70 ? "trusted" : stats && stats.trustScore >= 40 ? "caution" : "risky",
          size: "md",
          showIcon: true,
          children: stats && stats.trustScore >= 70 ? "Trusted" : stats && stats.trustScore >= 40 ? "Caution" : "Risky"
        }
      ) })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Fake vs. Real Reviews Trend" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 240, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        AreaChart,
        {
          data: trendData,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "realGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "stop",
                  {
                    offset: "5%",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "fakeGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "stop",
                  {
                    offset: "5%",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: (stats == null ? void 0 : stats.recentAnalyses.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "recent-analyses", children: stats.recentAnalyses.map((a2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex items-center gap-3 p-3 rounded-lg bg-muted/30 border border-border",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: a2.verdict, showIcon: true, children: a2.verdict }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-body text-foreground truncate", children: [
                  '"',
                  a2.reviewText.slice(0, 60),
                  '…"'
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: formatDate(a2.analyzedAt) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-display font-bold text-destructive flex-shrink-0", children: formatScore(a2.fakeScore) })
            ]
          },
          a2.id
        )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body text-center py-4", children: "No analyses yet." }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "w-4 h-4 text-accent" }),
          " Recent Product Checks"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: (stats == null ? void 0 : stats.recentProducts.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "recent-products", children: stats.recentProducts.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex items-center gap-3 p-3 rounded-lg bg-muted/30 border border-border",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-medium text-foreground truncate", children: p2.productName }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground font-body", children: [
                  p2.platform,
                  " · ",
                  formatDate(p2.checkedAt)
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Badge,
                {
                  variant: p2.trustLevel === "trusted" ? "trusted" : p2.trustLevel === "caution" ? "caution" : "risky",
                  showIcon: true,
                  children: [
                    formatScore(p2.fakePercentage),
                    " fake"
                  ]
                }
              )
          ...
          p2.id
        )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body text-center py-4", children: "No product checks yet." }) })
      ] })
    ] })
  ] }) });
}
